...
export default function Doctors() {
  ...
  return (
    <section className="doctors" id="doctors">
      ...
      <div className="doctors-testimonial">
        <p>
          Our dental team stays current with the latest advances in dentistry through continuing education and advanced training. We're passionate about helping you achieve optimal oral health and a confident smile that lasts a lifetime.
        </p>
      </div>
    </section>
  );
